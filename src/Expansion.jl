...
function expand(
        f::Function, ::Type{Union{}},
        itrs::Union{NTuple{N, T}, AbstractArray{T, N}}
    ) where {
        N,
        T <:
        AbstractArray,
...
function expand(
        f::Function, ::Type{L},
        itrs::Union{NTuple{N, <:L}, AbstractArray{<:L, N}}
    ) where {L, N}
    return itrs
end
function expand(
...
function expand(
        f::Function, ::Type{MoreMaps.All},
        ::Union{
            AbstractArray{<:MoreMaps.All, N},
            NTuple{N, <:MoreMaps.All},
        }
    ) where {N}
    return nothing
end
